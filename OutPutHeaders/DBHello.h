...
@interface DBHello : XXUnknownSuperclass <WCDBCoding> {
...
@property(assign, nonatomic) unsigned long sayHelloStatus;
@property(assign, nonatomic) unsigned long opCode;
@property(retain, nonatomic) NSString* userName;
@property(assign, nonatomic) unsigned long des;
...
@property(assign, nonatomic) long long msgServerId;
...
-(const WCDBCondition<unsigned long>*)db_sayHelloStatus;
-(const WCDBCondition<unsigned long>*)db_opCode;
-(const WCDBCondition<NSString* >*)db_userName;
-(const WCDBCondition<unsigned long>*)db_des;
...
-(const WCDBCondition<long long>*)db_msgServerId;
