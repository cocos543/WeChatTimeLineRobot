...
@interface ImageAutoControl : XXUnknownSuperclass <PBCoding> {
...
@property(assign, nonatomic) long m_nDownloadCount;
@property(assign, nonatomic) double m_douLimitBegin;
+(void)initialize;
-(id)init;
