...
@interface CDownloadVoiceWrap : XXUnknownSuperclass <WCDBCoding> {
...
-(const WCDBCondition<unsigned long>*)db_m_uiVoiceLen;
...
-(const WCDBCondition<NSString* >*)db_m_nsChatUsrName;
@end
