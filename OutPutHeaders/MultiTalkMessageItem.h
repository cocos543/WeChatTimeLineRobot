...
@property(assign, nonatomic) unsigned hasGenWCMessage;
...
-(id)getValueTable;
-(const WCDBCondition<unsigned long>*)db_hasGenWCMessage;
-(const WCDBCondition<NSString* >*)db_messageContent;
-(const WCDBCondition<unsigned long>*)db_messageType;
