...
+(void)ReportCustomEmoticonCountWhenStartRecover:(unsigned)recover;
+(void)ReportDesignerEmojiClickTagEntrance;
+(void)ReportDesignerEmojiTipsClickSendEmoticon;
+(void)ReportDesignerEmojiTipsClickAddEmoticon;
+(void)ReportDesignerEmojiTipsShowTips;
