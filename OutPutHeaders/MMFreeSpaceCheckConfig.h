...
@interface MMFreeSpaceCheckConfig : XXUnknownSuperclass <PBCoding> {
...
@property(assign, nonatomic) unsigned long m_lastAlertLowTime;
@property(assign, nonatomic) unsigned long m_lastAlertUrgentTime;
+(void)initialize;
