...
@interface MMLocationDBRecord : XXUnknownSuperclass <WCDBCoding> {
	unsigned long m_latitude;
	unsigned long m_longitude;
	NSString* m_address;
	long long m___rowID;
}
...
@property(assign, nonatomic) unsigned long m_longitude;
@property(assign, nonatomic) unsigned long m_latitude;
+(id)dummyObject;
-(void).cxx_destruct;
...
-(id)getValueTable;
-(const WCDBCondition<NSString* >*)db_m_address;
-(const WCDBCondition<unsigned long>*)db_m_longitude;
-(const WCDBCondition<unsigned long>*)db_m_latitude;
@end
