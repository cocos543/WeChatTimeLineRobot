...
@interface SessionStorageSetting : XXUnknownSuperclass <PBCoding> {
	BOOL isHasRecord;
...
@property(assign, nonatomic) unsigned long sessionVersion;
@property(assign, nonatomic) BOOL isHasRecord;
+(void)initialize;
