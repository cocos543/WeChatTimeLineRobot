...
@interface DBOplog : XXUnknownSuperclass <WCDBCoding> {
...
@property(assign, nonatomic) unsigned long oplogLen;
@property(retain, nonatomic) NSData* oplog;
@property(assign, nonatomic) unsigned long cmdId;
...
-(id)getValueTable;
-(const WCDBCondition<unsigned long>*)db_oplogLen;
-(const WCDBCondition<NSData* >*)db_oplog;
-(const WCDBCondition<unsigned long>*)db_cmdId;
