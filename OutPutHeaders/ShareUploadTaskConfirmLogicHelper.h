...
@class NSDictionary, ShareConfirmView, WCUploadTask, NSData, NSString;
...
@property(assign, nonatomic) __weak id<ShareUploadTaskConfirmLogicHelperDelegate> delegate;
-(void).cxx_destruct;
