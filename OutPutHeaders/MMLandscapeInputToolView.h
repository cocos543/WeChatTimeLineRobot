...
@protocol MMLandscapeInputToolViewDelegate;
...
@interface MMLandscapeInputToolView : MMUIView <MMGrowTextViewDelegate> {
	...
	id<MMLandscapeInputToolViewDelegate> m_delegate;
	BOOL m_bPositioning;
}
...
@property(assign, nonatomic) __weak id<MMLandscapeInputToolViewDelegate> m_delegate;
-(void).cxx_destruct;
