...
@interface FavFileRetainCount : XXUnknownSuperclass <WCDBCoding> {
	NSString* md5;
...
@property(assign, nonatomic) unsigned long itemLocalId;
...
-(id)getValueTable;
-(const WCDBCondition<unsigned long>*)db_itemLocalId;
