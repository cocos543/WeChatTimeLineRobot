...
@interface DBEmoticonDownload : XXUnknownSuperclass <WCDBCoding> {
	NSString* userName;
...
@property(assign, nonatomic) unsigned long messageFlag;
@property(retain, nonatomic) NSString* messageSource;
@property(assign, nonatomic) unsigned long messageFrom;
...
@property(assign, nonatomic) unsigned long imageStatus;
...
@property(retain, nonatomic) NSString* msgServerId;
...
-(const WCDBCondition<NSString* >*)db_messageSource;
-(const WCDBCondition<unsigned long>*)db_ConIntRes3;
-(const WCDBCondition<unsigned long>*)db_messageFrom;
-(const WCDBCondition<unsigned long>*)db_messageFlag;
...
-(const WCDBCondition<unsigned long>*)db_imageStatus;
...
-(const WCDBCondition<NSString* >*)db_msgServerId;
