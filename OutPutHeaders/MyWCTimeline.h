...
@interface MyWCTimeline : XXUnknownSuperclass <WCDBCoding> {
...
@property(assign, nonatomic) unsigned long m_groupHint;
...
-(id)getValueTable;
-(const WCDBCondition<NSData* >*)db_m_buffer;
-(const WCDBCondition<NSString* >*)db_m_fromUser;
-(const WCDBCondition<NSString* >*)db_m_id;
-(const WCDBCondition<unsigned long>*)db_m_groupHint;
