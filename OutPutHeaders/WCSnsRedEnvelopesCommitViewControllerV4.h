...
@class WCDataItem, MMLoadingView, NSString, UIImageView, MMTimer, EmoticonBoardView, MMGrowTextView, WCSelectorView, WCTimelinePOIPickerViewController, WCLocationInfo, WCRedEnvelopesControlData, WCMusicInfo, WCInputController, MMUILabel, UIButton, UIView, ImageSelectorController, ContactsSelectorController, MMTableViewInfo;
@protocol WCCommitViewAnimationDelegate, WCSnsRedEnvelopesCommitViewControllerDelegateV4;

@interface WCSnsRedEnvelopesCommitViewControllerV4 : MMUIViewController <InputControllerDelegate, BaseEmoticonViewDelegate, IMMAssetICloudExt, WCMultiImageScannerDelegateForHB, UIScrollViewDelegate, scrollViewDelegate, UITextViewDelegate, SelectorControllerDelegate, MMTableViewInfoDelegate, ContactsSelectorControllerDelegate, UIAlertViewDelegate, IMsgExt, WCFacadeExt, IMMGrowTextViewExt, WCTimelinePOIPickerViewControllerDelegate> {
	...
	WCRedEnvelopesControlData* _data;
	MMUILabel* _viewLimitLabel;
	MMUILabel* _totalMoneyLabel;
...
-(id)initWithImages:(id)images redEnvelopesData:(id)data;
